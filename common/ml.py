...
def cnn1(hidden, nhiddens=[512, 1024], nfilters=1024, kernel_size=2, batchnorm=None, gn_std=0.001, dropout=0.5):
...
def model_output(inputs, hidden, target, ymin, ymax, layers=[2048, 2048], dropout=0.5, batchnorm=None, gn_std=0.001, lr=5e-5, eps=1e-8):
